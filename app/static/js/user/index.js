            ...
            if (str.code == 200) {
                for (var i = 0; i < str.data.length; i++) {
                    var carousel = "                    <li class=\"featured-slide hentry\">\n" +
                        "                        <a class=\"thumbnail-link\" href=\"https://www.zhutibaba.com/demo/iux/825.html\">\n" +
                        "                            <div class=\"thumbnail-wrap\">\n" +
                        "                                <img width=\"800\" height=\"333\"\n" +
                        "                                                             src=\"/static/uploads/Tang-Wei-800x333.png\"\n" +
                        "                                                             class=\"attachment-iux_featured_large_thumb2 size-iux_featured_large_thumb2 wp-post-image\"\n" +
                        "                                                             alt=\"\"/>\n" +
                        "                            </div>\n" +
                        "                        </a>\n" +
                        "                        <div class=\"entry-header clear\">\n" +
                        "                            <h2 class=\"entry-title\"><a target=\"_blank\" href=\"https://www.zhutibaba.com/demo/iux/825.html\">"+str.data[i].title+"</a></h2>\n" +
                        "                        </div>\n" +
